...
"use strict";
	...
	function draw(x1, y1, x2, y2) {
		...
		var cssOutput = transitionPrefixed + ': all ' + time.toFixed(1) + 's cubic-bezier(' + x1.toFixed(2) + ', ' + y1.toFixed(2) + ', ' + x2.toFixed(2) + ', ' + y2.toFixed(2) + ')';
		...
		$('.car-linear').attr('style', transitionPrefixed + ': all ' + time + 's linear');
	}
});
